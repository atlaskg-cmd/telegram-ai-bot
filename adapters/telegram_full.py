...
class FullTelegramBot:
    ...
    def _setup_handlers(self):
        ...
        def get_main_keyboard(user_id: int = None):
            ...
            keyboard = [
                # Row 1: Weather (2 buttons)
                [
                    KeyboardButton(text="🌤 Погода Бишкек"),
                    KeyboardButton(text="🌤 Погода Москва")
                ],
                # Row 2: Currency rates
                [KeyboardButton(text="💱 Курс валют USD EUR")],
                # Row 3: Currency converter
                [
                    KeyboardButton(text="🇨🇳 Юань → Сом"),
                ...
                [
                    ...
                    KeyboardButton(text="📰 AI Дайджест")
                ],
                # Row 6: Crypto
                [
        ...
        async def cmd_start(message: Message):
            ...
            welcome_text = (
                ...
                f"┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛\n\n"
                f"🤖 <b>Я твой мульти-помощник</b>\n"
                f"           Telegram + WhatsApp\n\n"
                f"━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n\n"
                f"🌤 <b>ПОГОДА</b>\n"
                f"   • Бишкек, Москва, Ысык-Көл\n"
                f"   • Бөкөнбаево, Тон\n"
                f"   • 🌡️ Температура, 💧 Влажность\n"
                f"   • 💨 Ветер, 📝 Описание\n\n"
                f"💱 <b>ВАЛЮТЫ</b>\n"
                f"   • USD, EUR → KGS, RUB\n"
                f"   • 🇨🇳 Юань ↔ 🇰🇬 Сом\n"
                ...
                f"   • 📰 20+ источников\n\n"
                f"🎨 <b>КАРТИНКИ</b>\n"
                f"   • 🖼️ Генерация по описанию\n"
                f"   • ⚡ Быстро и бесплатно\n"
                f"   • 🎭 FLUX.1, SDXL модели\n\n"
                f"🤖 <b>AI АССИСТЕНТ</b>\n"
                f"   • 🧠 DeepSeek R1, GPT-4\n"
                f"   • 💬 Умные ответы\n"
                f"   • 🇰🇬🇷🇺 Кыргызский, русский\n\n"
                f"💰 <b>КРИПТОВАЛЮТЫ</b>\n"
                f"   • ₿ BTC, Ξ ETH, ₮ USDT\n"
        ...
        async def cmd_help(message: Message):
            help_text = (
                ...
                "<b>⚡ БЫСТРЫЕ КОМАНДЫ:</b>\n\n"
                "<b>🌤 ПОГОДА:</b>\n"
                "   • <code>🌤 Погода Бишкек</code>\n"
                "   • <code>🌤 Погода Москва</code>\n\n"
                "<b>💱 ВАЛЮТЫ:</b>\n"
                "   • <code>💱 Курс валют USD EUR</code>\n"
                "   • <code>🇨🇳 Юань → Сом</code>\n"
                "   • <code>🇰🇬 Сом → Юань</code>\n\n"
                "<b>🤖 AI:</b>\n"
                ...
                "<b>📰 НОВОСТИ:</b>\n"
                "   • <code>📰 Новости</code> — лента\n"
                "   • <code>📰 AI Дайджест</code> — анализ\n\n"
                "<b>💰 КРИПТО:</b>\n"
                "   • <code>💰 Криптовалюты</code> — курсы\n"
                "   • <code>📈 Мой Портфель</code> — трекинг\n\n"
                "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n\n"
        ...
        # ===== CURRENCY =====
        @self.dp.message(lambda msg: msg.text and "Курс валют USD EUR" in msg.text)
        ...
        async def btn_cny_to_kgs(message: Message):
            ...
            await message.reply(
                ...
                f"┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛\n\n"
                f"━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n\n"
                f"💬 <b>Введите сумму в юанях (CNY):</b>\n\n"
                f"<i>Например: 100 или 150.50</i>",
                parse_mode=ParseMode.HTML
            )
        ...
        async def btn_kgs_to_cny(message: Message):
            ...
            await message.reply(
                ...
                f"┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛\n\n"
                f"━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n\n"
                f"💬 <b>Введите сумму в сомах (KGS):</b>\n\n"
                f"<i>Например: 1000 или 500.50</i>",
                parse_mode=ParseMode.HTML
            )
        ...
        async def deepseek_chat_handler(message: Message):
            ...
            if not prompt:
                await message.reply(
                    ...
                    f"━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n\n"
                    f"💬 <b>Использование:</b>\n"
                    f"<code>/gpt4 ваш вопрос</code>\n\n"
                    f"━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n\n"
                    f"<b>Примеры запросов:</b>\n"
                    f"• <code>/gpt4 объясни квантовую физику</code>\n"
                    f"• <code>/gpt4 как приготовить плов?</code>\n"
                    f"• <code>/gpt4 напиши код на Python</code>",
                    parse_mode=ParseMode.HTML
                )
                return
        ...
        @self.dp.message(lambda msg: msg.text and "AI Ассистент" in msg.text)
        async def btn_ai_chat(message: Message):
            ...
            await message.reply(
                ...
                f"┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛\n\n"
                f"━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n\n"
                f"💡 <b>Задай вопрос AI ассистенту</b>\n\n"
                f"📝 <b>Формат:</b>\n"
                f"<code>/gpt4 ваш вопрос</code>\n\n"
                f"━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n\n"
                f"<b>Пример:</b>\n"
                f"<code>/gpt4 как выучить английский?</code>",
                parse_mode=ParseMode.HTML
            )
        ...
        async def generate_image_handler(message: Message):
            ...
            if not prompt:
                await message.reply(
                    ...
                    f"━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n\n"
                    f"💬 <b>Использование:</b>\n"
                    f"<code>/image описание картинки</code>\n\n"
                    f"━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n\n"
                    f"<b>Примеры:</b>\n"
                    f"• <code>/image кот в космосе</code>\n"
                    f"• <code>/image закат на море, фотореализм</code>\n"
                    f"• <code>/image киберпанк город, неон</code>",
                    parse_mode=ParseMode.HTML
                )
                return
        ...
        @self.dp.message(lambda msg: msg.text and "Генерация картинок" in msg.text)
        async def btn_generate_image(message: Message):
            ...
            await message.reply(
                ...
                f"━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n\n"
                f"💡 <b>Отправьте:</b>\n"
                f"<code>/image ваше описание</code>\n\n"
                f"━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n\n"
                f"<b>Пример:</b>\n"
                f"<code>/image красивый закат в горах</code>",
                parse_mode=ParseMode.HTML
            )
        ...
        async def callback_contacts(callback_query: types.CallbackQuery):
            ...
            if action == "add":
                ...
                await callback_query.message.edit_text(
                    f"┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓\n"
                    f"       🔍 <b>Поиск Контактов</b>\n"
                    f"┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛\n\n"
                    f"━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n\n"
                    f"💬 <b>Введите имя или телефон:</b>",
                    parse_mode=ParseMode.HTML
                )
        ...
        # ===== CRYPTO =====
        @self.dp.message(lambda msg: msg.text and "Криптовалюты" in msg.text)
        async def btn_crypto(message: Message):
            ...
            try:
                ...
                text += (
                    ...
                    f"Нажмите: <code>📈 Мой Портфель</code>"
                )
        ...
        # ===== ADMIN PANEL =====
        @self.dp.message(lambda msg: msg.text and "Админ-панель" in msg.text)
        ...
        async def handle_text(message: Message):
            ...
            if len(text) > 10 and text.endswith("?"):
                ...
                await message.reply(
                    ...
                    f"┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛\n\n"
                    f"━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n\n"
                    f"🤖 <b>Хотите ответ от AI?</b>\n\n"
                    f"Используйте:\n"
                    f"<code>/gpt4 {text}</code>\n\n"
                    f"━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n\n"
                    f"<i>Или выберите действие в меню</i> 👇",
                    parse_mode=ParseMode.HTML,
                    reply_markup=get_main_keyboard(user_id)
                )
                return
            ...
            await message.reply(
                ...
                f"Или используйте <code>/help</code> для справки",
                reply_markup=get_main_keyboard(user_id),
                parse_mode=ParseMode.HTML
            )
