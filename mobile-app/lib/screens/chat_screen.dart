      ...
      child: Column(
        ...
        children: [
          ...
          Wrap(
            ...
            children: [
              _ExampleChip('Что такое ИИ?', onPressed: _sendExample),
              _ExampleChip('Расскажи анекдот', onPressed: _sendExample),
              _ExampleChip('Напиши код', onPressed: _sendExample),
              _ExampleChip('Помоги с учебой', onPressed: _sendExample),
            ],
          ),
        ],
      ),
